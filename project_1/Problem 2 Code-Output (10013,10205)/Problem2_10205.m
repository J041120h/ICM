% Project 1, Problem 2 (b) Code
% Reproduce traces similar to Figure 1 in paper for PATIENT 10205
% ONLY produce plots for 11h
clear; clc;

% --------------------------DEFINING VARIABLES------------------------
% define paths for inputs/outputs. EDIT before running
PATH_ABP = ['C:\Users\danie\OneDrive\Desktop\ICM\s10205\s10205\' ...
    's10205-2631-06-14-11-38_ABP.txt'];   % change for path of ABP file
...
xlabel('Time (s)');
ylabel('ABP (mmHg)');
title('Patient #10205, Starting at 11 h');
box on; grid on;

print(fullfile(OUT_DIR,'Problem2_10205_11h.png'),'-dpng','-r300');
close(gcf);