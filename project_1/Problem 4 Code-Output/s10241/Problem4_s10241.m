%% Problem 4 - Patient s10241 Analysis
fprintf('\n=== Problem 4: Patient s10241 Analysis ===\n');
...
% Patient s10241 specific paths
patient_id = 's10241';
patient_name = 'Patient #10241';
PATH_ABP_actual = '/Users/carolli/desktop/ICM Physiome/Project1/s10241-3150-11-15-13-27_ABP.txt';
PATH_NUM_actual = '/Users/carolli/desktop/ICM Physiome/Project1/s10241-3150-11-15-13-27n.txt';
...
try
    ...
    if ~isempty(nz_idx_p2)
        ...
        if ~isempty(td_CO_Lmin_12h_p2)
            ...
            fprintf('Patient #10241 - First 12 hours (%d measurements)\n', length(td_CO_valid));
            fprintf('=================================================================\n');
            fprintf('\n');
