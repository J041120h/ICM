...
%        12: est12_coalees
%        13: est13_trivial
%        14: est14_Parlikar - Parlikar 2007 beat-averaged Windkessel (this work)
%
...
%   - v3.1 - 11/05/25 - added estimator #14 (Parlikar 2007); no other changes.
...
%   case 11,   x = est11_mf(abp,onset1,MAP,HR,age,gender);
    ...
    case 14,   x = est14_Parlikar(Period, MAP, Pdias, PP); % NEW
    otherwise, x = nan;
end

% synchronize time of segment
